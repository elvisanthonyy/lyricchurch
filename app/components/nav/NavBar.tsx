...
const NavBar = ({ name }: ChildProps) => {
  ...
  return (
    <nav className="flex z-20 h-auto w-full absolute top-0">
      ...
      <div className="mt-5 md:mt-10 md:border md:border-lyric-lightgray mx-auto rounded-[46px] z-30 flex  items-center justify-between md:w-[70%] left px-8 w-[90%] h-18 bg-white">
        {name === "home" && (
