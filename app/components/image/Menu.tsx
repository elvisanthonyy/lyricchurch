...
const Menu = ({ isMenuOpen }: ChildProps) => {
  return (
    <div
      ...
      } z-15 flex top-5 text-xl md:translate-y-0 md:text-sm md:font-medium md:h-10 md:top-9 md:justify-end md:w-[70%] md:z-50 md:bg-white/0 md:shadow-none md:flex font-semibold text-gray-900 -translate-x-[50%] rounded-3xl h-110 w-[90%] left-[50%] bg-white`}
    >
      <Link href={"/"}>
